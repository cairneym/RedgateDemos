...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "Cities (Application)"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 161
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'CityCountry', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'CityCountry', NULL, NULL
GO
